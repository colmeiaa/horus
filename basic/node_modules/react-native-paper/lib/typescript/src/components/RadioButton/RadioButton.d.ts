...
declare class RadioButton extends React.Component<Props> {
    ...
    static Item: (React.ComponentClass<Pick<import("./RadioButtonItem").Props, "label" | "style" | "onPress" | "labelStyle" | "status" | "value"> & {
        theme?: import("@callstack/react-theme-provider").$DeepPartial<Theme> | undefined;
    }, any> & import("@callstack/react-theme-provider/typings/hoist-non-react-statics").NonReactStatics<(React.ComponentClass<import("./RadioButtonItem").Props, any> & typeof import("./RadioButtonItem").RadioButtonItem) | (React.FunctionComponent<import("./RadioButtonItem").Props> & typeof import("./RadioButtonItem").RadioButtonItem), {}>) | (React.FunctionComponent<Pick<import("./RadioButtonItem").Props, "label" | "style" | "onPress" | "labelStyle" | "status" | "value"> & {
        theme?: import("@callstack/react-theme-provider").$DeepPartial<Theme> | undefined;
